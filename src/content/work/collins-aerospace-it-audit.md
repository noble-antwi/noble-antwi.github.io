---
title: "Collins Aerospace IT Audit: Post-Incident Assessment"
kicker: "Assessment · IT audit"
summary: "A graduate IT-audit engagement on a simulated aerospace breach: COBIT-framed planning, NIST 800-30 risk assessment, CMMC Level 3 gap analysis, five headline findings and a costed remediation roadmap."
category: assessment
status: academic
statusLabel: "Academic · Completed"
order: 60
period: "Fall 2025 · ITMM 586, Illinois Tech"
repo: https://github.com/noble-antwi/collins-aerospace-audit
docs: https://github.com/noble-antwi/collins-aerospace-audit/blob/main/docs/audit-findings-report.md
docsLabel: "Audit findings report"
stack: ["COBIT 2019", "NIST 800-30", "NIST 800-171", "CMMC 2.0", "ISO 27001"]
relatedTags: ["incident-response"]
stats:
  - { value: "5", label: "Key findings" }
  - { value: "18", label: "Risks identified" }
  - { value: "$4.5M+", label: "Remediation estimate" }
